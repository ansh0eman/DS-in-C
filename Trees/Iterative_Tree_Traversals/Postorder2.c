//Sure, an iterative postorder traversal can be achieved using two stacks
//or a single stack with a reversed output. Here's an example of how you can perform an 
